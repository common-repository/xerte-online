...
add_action("save_post", "xerteonlinewordpress_create");
add_action("before_delete_post", "xerteonlinewordpress_delete"); 

function xerteonlinewordpress_create($post_id)
{
...
function xerteonlinewordpress_delete($post_id){
