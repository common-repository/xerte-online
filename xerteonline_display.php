...
function xerteonlinewordpress_custom_post_type_template($single_template) {
...
add_filter( "single_template", "xerteonlinewordpress_custom_post_type_template" ) ;

function xerteonlinewordpress_display($content)
{
